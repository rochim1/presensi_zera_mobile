...
class GetTeamKpiAssignments extends UseCase<List<KpiAssignment>, KpiFilterParams> {
  final KpiRepository repository;
  GetTeamKpiAssignments({required this.repository});

  @override
  Future<Either<Failure, List<KpiAssignment>>> call(KpiFilterParams params) {
    return repository.getTeamAssignments(params);
  }
}
