...
class ReimbursementFilterBottomSheet extends StatefulWidget {
  final DateTime? initialStartDate;
  final DateTime? initialEndDate;
  final String? initialStatus;
  final Function(DateTime? startDate, DateTime? endDate, String? status)
  onApply;

  const ReimbursementFilterBottomSheet({
    super.key,
  ...
  @override
  State<ReimbursementFilterBottomSheet> createState() =>
      _ReimbursementFilterBottomSheetState();
}

class _ReimbursementFilterBottomSheetState
    extends State<ReimbursementFilterBottomSheet> {
  DateTime? _startDate;
  DateTime? _endDate;
  String? _status;
