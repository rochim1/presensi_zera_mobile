...
class ShiftFilterBottomSheet extends StatefulWidget {
  final DateTime? initialStartDate;
  final DateTime? initialEndDate;
  final Function(DateTime? start, DateTime? end) onApply;

  const ShiftFilterBottomSheet({
    super.key,
  ...
  @override
  State<ShiftFilterBottomSheet> createState() => _ShiftFilterBottomSheetState();
}

class _ShiftFilterBottomSheetState extends State<ShiftFilterBottomSheet> {
  DateTime? _startDate;
  DateTime? _endDate;
